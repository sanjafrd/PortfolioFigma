...
export function AboutPage() {
  return (
    <section className="min-h-screen flex items-center justify-center px-6 py-32 bg-gradient-to-br from-orange-50 via-rose-50 to-pink-50">
          ...
          >
            <div className="space-y-5">
              <p className="text-lg text-foreground/90 leading-relaxed">
                Je m'appelle <span className="text-primary">Sanjali Fredelisy</span> et j'évolue dans le domaine de la communication.
              </p>
              <p className="text-lg text-foreground/90 leading-relaxed">
